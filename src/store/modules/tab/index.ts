import type { RouteLocationNormalizedLoaded, Router, RouteRecordName } from 'vue-router';
...
export const useTabStore = defineStore('tab-store', {
  ...
  actions: {
    ...
    /** 初始化Tab状态 */
    iniTabStore(currentRoute: RouteLocationNormalizedLoaded, router: Router) {
      ...
      this.tabs = tabs.filter(item => {
        return router.hasRoute(item.name as RouteRecordName);
      });
