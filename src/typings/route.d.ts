...
declare namespace AuthRoute {
  ...
  type RouteKey =
    ...
    | 'multi-menu'
    | 'system-manage_first'
    | 'system-manage_first_second'
    | 'system-manage_first_second-new'
    | 'system-manage_first_second-new_third'
    // 系统管理
    | 'system-manage'
    | 'system-manage_user-manage'
    | 'system-manage_role-manage'
    | 'system-manage_menu-manage'
    | 'system-manage_indexImg-manage'
    | 'system-manage_user-center'
    | 'system-manage_studentQrCode-manage'
    | 'system-manage_countryandcity-manage'
    | 'test-menu'
    // 公寓管理
    | 'apartment'
    | 'apartment_apartment-manage'
    | 'apartment_houseType-manage'
    | 'apartment_tag-manage'
    | 'apartment_campus-manage'
    | 'apartment_aroundFacility-manage'
    | 'apartment_indoorFacility-manage'
    | 'apartment_subletHouse-manage'
    // 客户管理
    | 'customer'
    | 'customer_customer-manage'
    | 'customer_houseApply-manage'
    | 'customer_signing-manage'
    | 'customer_sublet-manage'
    | 'customer_singing-manage'
    | 'dashbord';
